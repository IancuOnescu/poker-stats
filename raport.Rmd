...
TODO: de adaugat statisticile despre maini si frecvente
...
plot(benford(factor_to_int(data$p_pot_sz), number.of.digits = 1))
plot(benford(factor_to_int(data$p_bankroll), number.of.digits = 1))
plot(benford(factor_to_int(data$win), number.of.digits = 1))
```

TODO: blah blah despre Chi-Square si convergenta
